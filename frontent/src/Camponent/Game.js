...
export const Game = () => {
  return (
    <div className='game-first-page'>
        <ChatBox/>
        <div className='gaming-vr'>
        <div className='text-game'>
     Welcome to the future of gaming!
      BlackHole Infiverse isn't just creating content
       – we're crafting the next generation of gaming experiences 
       that transcend traditional boundaries. We're diving headfirst 
       into the Metaverse, but that doesn't mean we're leaving anyone behind. Our diverse portfolio of games bridges the gap,
      offering groundbreaking titles playable anywhere, on any platform.

     </div>
     <div className='gaming-image'>
      <div className='gaming-img-div'>
        <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQCzsMA8MZ7uLkVJJKQkgULVsItsCfk0VMqgQ&s'/>
